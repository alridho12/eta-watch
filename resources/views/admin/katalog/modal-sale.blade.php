        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" id="formInputData">
                    ...
                    <div class="mb-3">
                        <label for="fk_id_katalog" class="form-label" re>Katalog</label>
                        <select class="form-select" id="fk_id_katalog" name="fk_id_katalog" required>
                            <option value="">Pilih Katalog</option>
                            @foreach ($option_katalog as $katalog)
                                <option value="{{ $katalog['value'] }}">{{ $katalog['label'] }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="harga_sales" class="form-label">Harga Sale</label>
                        <input type="number" class="form-control" id="harga_sales" name="harga_sales" required>
                    </div>
                    {{-- tambahkan input disini --}}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" id="formEditData">
                    ...
                    {{-- tambahkan input disini --}}
                    <div class="mb-3">
                        <label for="fk_id_katalog" class="form-label">Katalog</label>
                        <select class="form-select" id="fk_id_katalog" name="fk_id_katalog" required>
                            <option value="">Pilih Katalog</option>
                            @foreach ($option_katalog as $katalog)
                                <option value="{{ $katalog['value'] }}">{{ $katalog['label'] }}</option>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" id="formDetailData">
                    ...
                    <div class="mb-3">
                        <label for="fk_id_katalog" class="form-label">Katalog</label>
                        <select class="form-select" id="fk_id_katalog" name="fk_id_katalog" disabled>
                            <option value="">Pilih Katalog</option>
                            @foreach ($option_katalog as $katalog)
                                <option value="{{ $katalog['value'] }}">{{ $katalog['label'] }}</option>
                            @endforeach
                    ...
                    <div class="mb-3">
                        <label for="harga_normal" class="form-label">Harga Normal</label>
                        <input type="number" class="form-control" id="harga_normal" name="harga_normal" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="harga_sales" class="form-label">Harga Sale</label>
                        <input type="number" class="form-control" id="harga_sales" name="harga_sales" disabled>
                    </div>
                    {{-- tambahkan input disini --}}
